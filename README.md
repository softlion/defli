...
```powershell
pwsh -ExecutionPolicy Bypass -Command "iwr 'https://raw.githubusercontent.com/softlion/defli/main/defli.ps1' | iex"
...
```shell
curl https://raw.githubusercontent.com/softlion/defli/main/defli.sh | sudo bash
